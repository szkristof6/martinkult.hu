  ...
  if (!e.TweenLite) {
    ...
    var G = t(
        ...
        function (b, c, d) {
          ...
          if (
            ((this._overwrite = i = null == i ? U[G.defaultOverwrite] : "number" == typeof i ? i >> 0 : U[i]),
      ...
      return (
        ...
        (d.render = function (t, e, i) {
          ...
          if (t >= u)
            ...
            if (
              ((this._totalTime = this._time = 0),
              (0 !== f || (0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || (0 > t && this._rawPrevTime >= 0)))) &&
              ...
              o &&
                (this._gc ||
                  ((c === this._startTime || p !== this._timeScale) &&
                    ...
                    (n && (l.length && _(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)),
            ...
            function (a) {
              ...
              (k = 1),
                ...
                (p || L) &&
                  ...
                  L &&
                    ((H += z.xOrigin - (z.xOrigin * c + z.yOrigin * d) + z.xOffset), (I += z.yOrigin - (z.xOrigin * f + z.yOrigin * g) + z.yOffset)),
                  q > H && H > -q && (H = w),
                  q > I && I > -q && (I = w),
                  q > J && J > -q && (J = 0)),
  ...
  var b = a.GreenSockGlobals || a,
        ...
        (c = d[b]),
          c._isSplit
            ...
            : (b && 3 === c.previousSibling.nodeType
                ? (c.previousSibling.nodeValue += 3 === c.nodeType ? c.nodeValue : c.firstChild.nodeValue)
    ...
    E = function (a, b, c, d, e, h, j) {
      var k,
        ...
        V = [];
      for (
        P && 1 === a.children.length && a.children[0]._isSplit && (a = a.children[0]),
          U && (T = T.split("++").join("")),
        ...
        for (k = 0; m > k; k++)
          (n = o[k]),
            ...
            (p || S || (R && !Q)) &&
              ...
              P &&
                (((n._isSplit && p) || (!R && p) || (Q && p) || (!Q && n.parentNode.parentNode === a && !n.parentNode._isSplit)) &&
      ...
      if (P) {
        for (
          S &&
            ((t = f.createElement(N)), a.appendChild(t), (u = t.offsetWidth + "px"), (v = t.offsetParent === a ? 0 : a.offsetLeft), a.removeChild(t)),
            s = a.style.cssText,
        ...
        for (r = " " === M && (!S || (!Q && !R)), k = 0; k < P.length; k++) {
          for (
            ...
            "BR" !== q[l].nodeName &&
              ...
              S &&
                (0 === l && ((t.style.top = n._y + "px"), (t.style.left = x + v + "px")),
                (n.style.top = "0px"),
      ...
      S &&
        (j > a.clientHeight && ((a.style.height = j - F + "px"), a.clientHeight < j && (a.style.height = j + B + "px")),
