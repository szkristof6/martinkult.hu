function scrollAndFocus(t, e, o, i, s) {
  ...
  (n = jQuery)("body").addClass("scrolling"),
    ...
    n("html, body").animate({ scrollTop: n(e).offset().top - (i || 0) }, 300, function () {
      n("body").removeClass("scrolling"),
        setTimeout(function () {
          n(o).focus();
        }, 500),
        s && n("html, body").animate({ scrollTop: n(e).offset().top - (i || 0) });
    });
}
if (
  ((function (p) {
      ...
      browserSelector: function () {
        ...
        var e = "ontouchstart" in window || navigator.msMaxTouchPoints,
          ...
          d = [
            !/opera|webtv/i.test(o) && /msie\s(\d)/.test(o)
              ...
              ? s
              : i("opera")
              ? r + (/version\/(\d+)/.test(o) ? " " + r + RegExp.jQuery1 : /opera(\s|\/)(\d+)/.test(o) ? " " + r + RegExp.jQuery2 : "")
              : i("konqueror")
              ? "konqueror"
              : i("chrome")
              ? n + " chrome"
              ...
              ? n + " iron"
              : i("applewebkit/")
              ? n + " " + a + (/version\/(\d+)/.test(o) ? " " + a + RegExp.jQuery1 : "")
              : i("mozilla/")
              ? s
              : "",
            i("j2me")
        ...
        (c = d.join(" ")),
          ...
          !window.ActiveXObject && "ActiveXObject" in window
            ...
            : (p("body").hasClass("dark") && p("html").addClass("dark"), p("body").hasClass("boxed") && p("html").addClass("boxed"));
      },
    }),
      p.browserSelector();
  })(jQuery),
      ...
      setTimeout(function () {
        ...
        $(t).get(0) &&
          ($("a[href$='" + window.location.hash + "']").is("[data-hash-offset]")
            ...
            : $("html").is("[data-hash-offset]") && (e = parseInt($("html").attr("data-hash-offset"))),
          $("body").addClass("scrolling"),
          $("html, body").animate({ scrollTop: $(t).offset().top - e }, 600, "easeOutQuad", function () {
          ...
          s(t).fadeIn(e.fadeSpeed, function () {
            s(t)
              ...
              .fadeOut(e.fadeSpeed, function () {
                var t = s(this).next();
                0 == t.length && (t = s(o).children(":first")), s(o).textRotator({ child: t, fadeSpeed: e.fadeSpeed, pauseSpeed: e.pauseSpeed });
              });
          });
        });
      },
  ...
  (function (e) {
    e("body[data-plugin-page-transition]").get(0) &&
      ...
      (e(".thumb-info-floating-caption")
        .on("mouseenter", function () {
          e(".thumb-info-floating-caption-title").get(0) ||
            (e(".body").append('<div class="thumb-info-floating-caption-title">' + e(this).data("title") + "</div>"),
            e(this).data("type") &&
    ...
    (u.version = "0.7.2"),
      ...
      (u._apply = function (t, e) {
        ...
        return (
          ...
          u._maintainScroll && l(window).scrollTop((s / a) * l("html").outerHeight(!0)),
          this
        );
      }),
      ...
      (h.fn.waitForImages = function () {
        ...
        if (
          (h.isPlainObject(arguments[0])
            ? ((e = arguments[0].waitForAll), (r = arguments[0].each), (a = arguments[0].finished))
            : (e =
                1 === arguments.length && "boolean" === h.type(arguments[0]) ? arguments[0] : ((a = arguments[0]), (r = arguments[1]), arguments[2])),
          (a = a || h.noop),
          (r = r || h.noop),
          (e = !!e),
          ...
          this.each(function () {
            ...
            e
              ? t
                  ...
                  .each(function () {
                    var s = h(this);
                    s.is("img:has-src") && !s.is("[srcset]") && p.push({ src: s.attr("src"), element: s[0] }),
  ...
  (function (t, c) {
    fontSpy = function (t, e) {
      ...
      var l = function () {
        var t = a.outerWidth();
        r !== t
          ? (n.callback(), o.addClass(n.fontClass), n && n.success && n.success(), a.remove())
          : n.timeOut < 0
          ? (o.addClass("no-" + n.fontClass), n && n.failure && n.failure(), n.callback(new Error("FontSpy timeout")), a.remove())
            ...
            for (var t = [], e = 0, o = c.length; e < o; e++) {
              ...
              if (s) {
                ...
                n + i.outerHeight() > s.end
                  ? i.css("position", "")
                  : n < r && r < a
                  ? ("fixed" != i.css("position") && i.css({ left: i.offset().left, top: s.pad.top }).css("position", "fixed"),
                    l.activeClass && i.addClass(l.activeClass))
                  : a <= r
                  ? (i.css({ left: "", top: a - s.parentTop + s.pad.top }).css("position", "absolute"), l.activeClass && i.addClass(l.activeClass))
                  : (i.css({ position: "", top: "", left: "" }), l.activeClass && i.removeClass(l.activeClass));
              }
            }
            c = t;
          }
  ...
  jQuery(document).ready(function (a) {
    ...
    function f(t) {
      ...
      if (t.parents(".word-rotator").hasClass("type")) {
        ...
        t.parents(".word-rotator").hasClass("clip")
          ? t.parents(".word-rotator-words").animate({ width: "2px" }, h, function () {
              w(t, e), m(e);
            })
    ...
    function m(t, e) {
      t.parents(".word-rotator").hasClass("type")
        ? (v(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden"))
        : t.parents(".word-rotator").hasClass("clip") &&
          t.parents(".word-rotator-words").animate({ width: t.outerWidth() + 10 }, h, function () {
            setTimeout(function () {
              f(t);
            }, o);
          });
      ...
      t.addClass("in").removeClass("out"),
        t.is(":last-child")
          ? (e.parents(".word-rotator").hasClass("type") &&
            ...
            e.closest(".word-rotator").hasClass("type") || e.closest(".word-rotator-words").animate({ width: e.outerWidth() }))
          : setTimeout(function () {
              v(t.next(), e, o, i);
            }, i);
    }
    ...
    function w(t, e) {
      if (
        ...
        (e.closest(".word-rotator").hasClass("loading-bar") || e.closest(".word-rotator").hasClass("slide")) && ((o = 3), (i = 0)),
          setTimeout(function () {
  ...
  (function (e) {
    e.fn.hover3d = function (t) {
      ...
      return this.each(function () {
        ...
        t.css({ perspective: h.perspective + "px", transformStyle: "preserve-3d" }),
          p.css({ perspective: h.perspective + "px", transformStyle: "preserve-3d" }),
          u.css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0, transform: "translateZ(1px)", "z-index": 9 }),
          ...
          t.on("mousemove", function (t) {
            return (
              ...
              (a = h.invert ? (o / 2 - s) / h.sensitivity : -(o / 2 - s) / h.sensitivity),
              (r = h.invert ? -(i / 2 - n) / h.sensitivity : (i / 2 - n) / h.sensitivity),
              (l = s - o / 2),
              (c = n - i / 2),
              (d = (180 * Math.atan2(c, l)) / Math.PI - 90) < 0 && (d += 360),
              p.css({ perspective: h.perspective + "px", transformStyle: "preserve-3d", transform: "rotateY(" + a + "deg) rotateX(" + r + "deg)" }),
          ...
          t.on("mouseleave", function () {
            return (
              ...
              p.css({ perspective: h.perspective + "px", transformStyle: "preserve-3d", transform: "rotateX(0) rotateY(0)" }),
              void setTimeout(function () {
  ...
  var t = {
    ...
    build: function () {
      ...
      o(window).height() - o(".header-body").height() < t
        ? (o("#footer").removeClass("footer-reveal"), o("body").css("padding-bottom", 0))
        : (o("#footer").addClass("footer-reveal"), o("body").css("padding-bottom", t));
    },
    events: function () {
      var t = this,
        e = o(window);
