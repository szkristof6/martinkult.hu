!(function (l, o, n, a) {
  ...
  (l.fn.lazyload = function (e) {
    ...
    return (
      ...
      this.each(function () {
        var o = this,
          n = l(o);
        (o.loaded = !1),
          (n.attr("src") !== a && !1 !== n.attr("src")) || (n.is("img") && n.attr("src", f.placeholder)),
    ...
    (l.rightoffold = function (e, t) {
      return (
        (t.container === a || t.container === o ? h.width() + h.scrollLeft() : l(t.container).offset().left + l(t.container).width()) <=
        l(e).offset().left - t.threshold
      );
    }),
    (l.abovethetop = function (e, t) {
      return (
        (t.container === a || t.container === o ? h.scrollTop() : l(t.container).offset().top) >= l(e).offset().top + t.threshold + l(e).height()
      );
    }),
    (l.leftofbegin = function (e, t) {
      return (
        (t.container === a || t.container === o ? h.scrollLeft() : l(t.container).offset().left) >= l(e).offset().left + t.threshold + l(e).width()
      );
    }),
