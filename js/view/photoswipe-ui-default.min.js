...
!(function (a, b) {
  ...
  var a = function (a, b) {
    var c,
      ...
      M = function () {
        q.fullscreenEl &&
          ...
          c
            ? (b.bind(document, c.eventK, v.updateFullscreen), v.updateFullscreen(), b.addClass(a.template, "pswp--supports-fs"))
    ...
    (v.init = function () {
      ...
      (v.update = function () {
        x && a.currItem
          ? (v.updateIndexIndicator(), q.captionEl && (q.addCaptionHTMLFn(a.currItem, e), C(e, "caption--empty", !a.currItem.title)), (w = !0))
          : (w = !1),
          y || F(),
          D();
      }),
